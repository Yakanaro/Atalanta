                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
                    ...
                    <div class="p-4 space-y-3">
                        <div class="grid grid-cols-3 gap-2 bg-gray-100 dark:bg-gray-700 p-2 rounded">
                            ...
                            <div class="flex flex-col items-center">
                                <span class="text-xs text-gray-500 dark:text-gray-400">Вес</span>
                                <span class="font-bold text-gray-900 dark:text-white">{{ $position->formatted_weight ?? '-' }}</span>
                                <span class="text-xs text-gray-500 dark:text-gray-400">кг</span>
                            </div>
                        </div>
